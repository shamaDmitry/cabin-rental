...
const cabins: Cabin[] = [
  {
    ...
    amenities: [
      { id: uuidv4(), content: "Jetted Tub" },
      { id: uuidv4(), content: "Flat Panel TV" },
      { id: uuidv4(), content: "Fireplace" },
      { id: uuidv4(), content: "Wi-Fi" },
    ],
  },
  {
    id: uuidv4(),
    ...
    amenities: [
      { id: uuidv4(), content: "Hot Tub" },
      { id: uuidv4(), content: "Pool Table" },
      { id: uuidv4(), content: "Jacuzzi Tub" },
      { id: uuidv4(), content: "Wi-Fi" },
    ],
  },
  {
    ...
    amenities: [
      { id: uuidv4(), content: "Whirlpool Tub" },
      { id: uuidv4(), content: "Air Hockey" },
      { id: uuidv4(), content: "Fireplace" },
      { id: uuidv4(), content: "Wi-Fi" },
    ],
  },
  ...
  },
  {
    ...
    amenities: [
      { id: uuidv4(), content: "Private Indoor Pool" },
      { id: uuidv4(), content: "Pool Table" },
      { id: uuidv4(), content: "Hot Tub" },
      { id: uuidv4(), content: "Air Hockey" },
    ],
